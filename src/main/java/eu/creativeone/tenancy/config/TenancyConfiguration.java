...
@Configuration
@EnableJpaRepositories(entityManagerFactoryRef = "tenancyEntityManager",transactionManagerRef = "transactionManager")
...
public class TenancyConfiguration implements EnvironmentAware
{
    ...
    public LocalContainerEntityManagerFactoryBean tenancyEntityManager() throws Throwable {
        ...
        entityManager.setPackagesToScan("eu.creativeone.tenancy.domain");
        entityManager.setPersistenceUnitName("tenantPersistenceUnit");
    ...
    public DataSource tenancyDataSource() {
        ...
        if (propertyResolver.getProperty("url") == null || "".equals(propertyResolver.getProperty("url"))) {
            ...
            config.setJdbcUrl("jdbc:mariadb://localhost:3306/" + env.getProperty("spring.application.name"));
        }
